...
namespace Capa_de_Datos
{
    public class DServicio
    {
        ...
        public static string InsertarServicios(EServicio Servicio)
        {
            string Resultado = "";
            ...
            {
                sqlcon = Conexion.GetInstancia().CrearConexion();
                SqlCommand comando = new SqlCommand("Servicios_Insertar_Sin_Fotos", sqlcon);
                comando.CommandType = CommandType.StoredProcedure;
        ...
        public static string ActualizarServicios(EServicio servicio)
        {
            string Resultado = "";
        ...
        public static string Servicio_ActualizarExiste(EServicio servicio)
        {
            string Resultado = "";
            SqlConnection sqlcon = new SqlConnection();
